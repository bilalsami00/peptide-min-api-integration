...
interface AddEditPeptideModalProps {
  ...
  setGoal: (goal: string) => void;
  // onSuccess: () => void;
    onSuccess: (data: { type: "create" | "update"; event: CalendarEvent }) => void;
...
//         ? `https://peptide-backend.mazedigital.us/peptide-dosage/update/${editingEvent?.databaseId}`
//         : "https://peptide-backend.mazedigital.us/peptide-dosage/create";
...
//       setAuthError(error.message || "Operation failed. Please try again.");
//     } finally {
//       setIsSubmitting(false);
//     }
//   };
const handleSubmit = async () => {
  ...
  try {
    ...
    const eventData: CalendarEvent = {
      ...
      peptide: selectedPeptide as PeptideOption,
      dosage,
      goal,
      id: editingEvent?.id || Date.now().toString(),
      databaseId: result.id,
      isFDAApproved: selectedPeptide ? getFDAStatus(selectedPeptide.tag) : false,
      dateValue: dayjs(selectedDate as string).format("YYYY-MM-DD")
    };
